...
* При старте приложения будут созданы два студента и помещены в список.
  ...
  ![Создание студентов по умолчанию](https://github.com/vadimsa3/skillbox-second-task/tree/master/second-task/src/main/resources/raw/start-create.jpg "Создание студентов по умолчанию")
