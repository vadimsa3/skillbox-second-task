...
* При старте приложения будут созданы два студента и помещены в список.
  ...
  ![Изображение](https://github.com/vadimsa3/skillbox-second-task/tree/master/second-task/src/main/resources/raw/start_create.jpg "Создание студентов по умолчанию")
...
2. Из командной строки, командой help можно получит перечень доступных приложению команд.
   ![Изображение](https://github.com/vadimsa3/skillbox-second-task/tree/master/second-task/src/main/resources/raw/list_commands.jpg "Доступные команды")
